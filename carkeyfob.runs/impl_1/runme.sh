...
HD_PWD='C:/Users/DELL/carkeyfob/carkeyfob.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log car_key_fob_advancedversion.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source car_key_fob_advancedversion.tcl -notrace
