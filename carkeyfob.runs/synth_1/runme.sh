...
HD_PWD='C:/Users/DELL/carkeyfob/carkeyfob.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log car_key_fob_advancedversion.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source car_key_fob_advancedversion.tcl
